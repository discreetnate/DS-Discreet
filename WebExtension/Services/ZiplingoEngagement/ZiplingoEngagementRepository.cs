        ...
        public void ResetSettings()
        {
            try
            {
                using (var dbConnection = new System.Data.SqlClient.SqlConnection(_dataService.GetClientConnectionString().Result))
                {
                    ...
                    var parameters = new
                    {
                        Username = "HypochlorusAPI",
                        Password = "c98e6767-abd4-4a07-9e3c-423a78dae17a",
                        ApiUrl = "http://unifiedbetaapi.ziplingo.com/api/",
                        LogoUrl = "https://hypochlorus.corpadmin.directscale.com/CMS/Images/Logo-Default-230px.png",
                        settings.CompanyName
                    };
